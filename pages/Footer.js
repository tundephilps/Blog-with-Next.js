...
const Footer = () => {
  return (
    <footer class="px-4 py-12 mx-auto bg-gray-950 text-white ">
      <div class="grid grid-cols-2 gap-10 mb-3 md:grid-cols-3 lg:grid-cols-12 lg:gap-20">
        <div class="col-span-3">
          ...
          <p class="my-4 text-xs leading-normal text-gray-200">
        ...
        <nav class="col-span-1 md:col-span-1 lg:col-span-2">
          ...
          <a
            href="#"
            class="flex mb-3 text-sm font-medium text-gray-300 transition md:mb-2 hover:text-primary"
          >
            Features
          </a>
          <a
