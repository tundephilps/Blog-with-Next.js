            ...
            <div class="py-8 lg:pr-4 ">
              <div class="space-y-5 lg:space-y-8">
                ...
                <div class="flex items-center gap-x-5">
                  ...
                  <p class="text-xs sm:text-sm text-gray-800 ">{published}</p>
                </div>

                <p class="text-lg text-gray-800 ">{article1}</p>
                ...
                <p class="text-lg text-gray-800">{article2}</p>
                ...
                <div class="space-y-3">
                  ...
                  <p class="text-lg text-gray-800">{article3}</p>
                </div>
